...
curl -i -X PUT http://localhost:8080/modules/puppetlabs/apache/puppetlabs-apache-1.5.0.tar.gz -T ./puppetlabs-apache-1.5.0.tar.gz
curl -i -X PUT http://localhost:8080/modules/puppetlabs/concat/puppetlabs-concat-1.2.3.tar.gz -T ./puppetlabs-concat-1.2.3.tar.gz
curl -i -X PUT http://localhost:8080/modules/puppetlabs/stdlib/puppetlabs-stdlib-4.6.0.tar.gz -T ./puppetlabs-stdlib-4.6.0.tar.gz
